...
for sub_series_number in `echo $sub_series_number_list`; do
	...
	*) echo "Wrong subseries number '${1}'; doing full series"
    ...
    echo "<div style=\"text-align:left; font-size:medium;\">[Click on \"Points\", \"# of races\" or \"Points/Race\" to re-sort. Overall rank remains based on total number of points.]</div><br>" >>  $html_file
