...
for sub_series_number in `echo $sub_series_number_list`; do
	...
	*) echo "Wrong subseries number '${1}'; doing full series"
    ...
    echo "<tr style=\"background-color:yellow\"> <th class=\"th_sortable\"onclick=\"sortTable(6)\">Rank<span style=\"font-size:xx-large;color:Gray;\">&#8597;</span></th> <th>Rouvy username</th> <th class=\"th_sortable\" onclick=\"sortTable(6)\">Points<span style=\"font-size:xx-large;color:Gray;\">&#8597;</span></th> <th class=\"th_sortable\" onclick=\"sortTable(7)\"><span style=\"white-space:nowrap;\">
# of races</span><span style=\"font-size:xx-large;color:Gray;\">&#8597;</span></th> <th class=\"th_sortable\" onclick=\"sortTable(8)\">Points/Race<span style=\"font-size:xx-large;color:Gray;\">&#8597;</span></th> </tr>" >>  $html_file
