...
find . \( -iname 'results.html' -o -iname 'all_races_in_series.html' -o -iname 'league_table*.html' -o -iname 'style.css' -o -iname 'script.js' -o -iname 'head_to_head_race_results.js' -o -iname 'head_to_head_active_users.js' \) -print0 | tar -hcf  generated_html_files.tar --null -T -
