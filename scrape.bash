...
#https://my.rouvy.com/onlinerace/detail/65946
#https://my.rouvy.com/onlinerace/detail/65945
#https://my.rouvy.com/onlinerace/detail/65943
...
race_id_list[8]="65943 65945 65946"
...
for race_number in `echo $race_number_list`; do
    ...
    `echo $paste_command` | awk 'BEGIN{error=0}{printf "<tr>"; if (($1!=$4) || ($4!=$7)){error=1} else {printf("<td> %s </td>\t",$1); if (($3=="dns")&&($6=="dns")&&($9=="dns")){printf "<td> DNS </td>"} else if (($3=="dnf")||($6=="dnf")||($9=="dnf")){printf "<td> DNF </td>"} else {for (i=1;i<4;i++){ j=3*i; if (substr($j,1,2)!="dn"){printf "<td> "$j" </td>"} } } }; print "</tr>" }  END{if (error==1){print "Error: Names dont match!"} } ' > .tmp_file
